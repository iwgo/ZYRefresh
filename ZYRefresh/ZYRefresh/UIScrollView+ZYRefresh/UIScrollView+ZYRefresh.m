...
//            zy_footer.frame = CGRectMake(self.frame.size.width, 0, 64, self.frame.size.height);
//        } else {
//            zy_footer.frame = CGRectMake(self.contentSize.width, 0, 64, self.frame.size.height);
//        }
